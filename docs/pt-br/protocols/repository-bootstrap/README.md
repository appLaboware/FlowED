# Repository Bootstrap Protocol (RBP)

Este diretório contém o protocolo FlowED para formação inicial de repositórios.

Objetivo: permitir que projetos diferentes nasçam com uma base homogênea, rastreável, validável e amigável a humanos e agentes de IA, sem transformar um template físico em autoridade normativa.
